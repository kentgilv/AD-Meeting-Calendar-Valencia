...
<body>
    <?php if ($pageTitle == "Home | Meeting Calendar" )
        require_once COMPONENTS_PATH . "/templates/headerNav.component.php";

        elseif ($pageTitle == "Login | Meeting Calendar" || $pageTitle == "Signup | Meeting Calendar")
        ...
        elseif ($pageTitle == "Admin Dashboard | Meeting Calendar")
